const items = [{
        title: "DIOR",
        brands: "Dior Beauty",
        description: "24 миниатюрных средства - для ухода за кожей и макияжа, изысканные ароматы и ароматическая свеча",
        price: 600,
        img: "./img/1.jpg",
    ...
    },
    {
        ...
        brands: "Yves Saint Laurent Beauty",
        description: "5 популярных полноформатных продукта и 18 мини-версий - для макияжа, ароматы и уход за кожей",
        price: 287,
        img: "./img/2.jpg",
    ...
    {
        title: "SPACE NK",
        brands: ["111Skin", "Naturium", "Kosas", "Milk", "Boy Smells", "Laneige", "Erborian", "Tatcha"],
    ...
    },
    {
        ...
        brands: ["Elemis", "Origins", "MAC", "Eve Lom", "NARS", "NUDESTUX", "Sol de Janeiro"],
    ...
    {
        title: "CULT BEAUTY",
        brands: ["Bare Minerals", "Votary", "REN", "Summer Fridays", "Augustinus Bader"],
